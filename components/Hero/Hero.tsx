...
const Hero = () => {
  return (
    <div className=' grid sm:mt-[1vh] md:mt-[4vh]  grid-rows-2 sm:grid-cols-1 sm:grid-rows-2 md:grid-cols-2 items-center w-8/12 mx-auto  bg-primary-100 ' > 
        <div className=' h-[45vh]  col-span-1 sm:row-span-1 '>
            <h1 className=' my-6 text-[280%] sm:text-[300%] md:text-[100%]] text-primary-400  leading-[1.05] font-bold tracking-tighter ' >
