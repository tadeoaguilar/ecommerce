...
const Hero = () => {
  return (
    ...
    <div className=' h-full col-span-1 sm:row-span-1 border-2 '>
            ...
            <p className=' text-[150%] leading-[1.2] text-primary-400 mb-6 2xl:text-[36px] '>
                The smart 365-days-per-year food subscription that will make you
                eat healthy again. Tailored to your personal tastes and
                nutritional needs.
            </p>
        </div>
        <div className=' h-32 self-start md:self-center relative 2xl:hidden max-w-6xl   sm:row-span-1 '>
            <Image src='/hero-min.png' alt='main' layout='fill' />
        </div>
     </div>
        <div className='grid grid-col-4 w-8/12 mx-auto mt-6 '>
